	...
	<head>
		...
		<script>
			function getInfo(){
				...
				if(link==""){
					$("#result").html('<div class="col-md-12"><div class="tuyin first"><div class="alert alert-danger">Lütfen geçerli bir Instagram kullanıcı adı girin</div></div></div>');
				}else{
		  ...
		  <div class="row transparent">  
			...
			<div class="col-md-12">
				...
				<p class="copyright text-center">
					Copyright &copy <?php echo date('Y'); ?> by <a href="https://www.beybilisimtasarim.com" target="_blank">Baki Enes Yalçın</a>
				</p>
			</div>	
		  </div>
		</div>
